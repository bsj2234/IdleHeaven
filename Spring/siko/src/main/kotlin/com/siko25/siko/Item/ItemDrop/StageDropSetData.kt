...
@Document
data class StageDropSetData(
        @Id val id: String,
        val stageDropSet: StageDropSet,
        val clearDropSet: ClearDropSet,
) 

@Document data class StageDropSet(val dropSets: Array<ItemData>, val dropCount: RandomCount)

@Document data class ClearDropSet(val dropSets: Array<ItemData>)
